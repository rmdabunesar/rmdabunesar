...
|-----------|---------------|------------|----------------|--------|
| **Custom WordPress Booking System** | WordPress, PHP, jQuery, MySQL | WordPress Plugin | A dynamic consultant booking system with CPTs, AJAX validation & payment gateway. | [![Go to Project](img.shields.io)](https://your-project-url.com) |
...
| **Shopify Theme Customization** | Liquid, CSS, JS | Shopify Theme | Custom product templates, optimized performance & dynamic upsells. | <a href="https://example.com"><img src="https://img.shields.io/badge/VIEW%20SITE-2ea44f?style=for-the-badge" width="150px"></a> |
