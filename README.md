...
## ✅ Projects
| 🧩 Project Name | 🛠️ Tech Stack | 💼 Category | 📝 Description | 🔗 Live |
|------------------|---------------|-----------------|------------------------------------------------------|--------|
| **Rupai Food**   | WordPress     | E-commerce Store | Fruit selling store • Payment gateway integrated • Elegant & responsive design | [![View Site](https://img.shields.io/badge/View%20Site-2ea44f?style=for-the-badge)](https://rupaifood.com) 🔗 |
| **AGS Limousine**| WordPress     | Car Rental       | Car booking website • Booking system • Mobile-friendly UI | [![View Site](https://img.shields.io/badge/View%20Site-2ea44f?style=for-the-badge)](https://agsllimousine.com) 🔗 |
